...
The current milestone includes the visual foundation, typed navigation, searchable local conversations, contact selection, and an in-memory message timeline with a composer. Message persistence will be introduced in later pull requests.
